...
import com.codecore.appointment.configuration.AppointmentModuleConfiguration;
import com.codecore.appointment.infrastructure.adapters.R2dbcAppointmentReferenceAdapter;
import com.codecore.appointment.infrastructure.persistence.repository.R2dbcAppointmentAdminQueryRepository;
import com.codecore.appointment.infrastructure.persistence.repository.R2dbcAppointmentRepository;
import com.codecore.appointment.interfaces.http.AppointmentHttpExceptionHandler;
import com.codecore.appointment.interfaces.http.admin.AppointmentAdminController;
import com.codecore.encounter.configuration.EncounterModuleConfiguration;
import com.codecore.encounter.infrastructure.persistence.repository.R2dbcEncounterAdminQueryRepository;
import com.codecore.encounter.infrastructure.persistence.repository.R2dbcEncounterRepository;
import com.codecore.encounter.interfaces.http.EncounterHttpExceptionHandler;
import com.codecore.encounter.interfaces.http.admin.EncounterAdminController;
...
@Import({
        ...
        AppointmentModuleConfiguration.class,
        EncounterModuleConfiguration.class,
        ...
        R2dbcAppointmentRepository.class,
        R2dbcAppointmentAdminQueryRepository.class,
        R2dbcAppointmentReferenceAdapter.class,
        R2dbcEncounterRepository.class,
        R2dbcEncounterAdminQueryRepository.class,
        ...
        AppointmentAdminController.class,
        EncounterAdminController.class,
        IamHttpExceptionHandler.class,
        OrgHttpExceptionHandler.class,
        PatientHttpExceptionHandler.class,
        AppointmentHttpExceptionHandler.class,
        EncounterHttpExceptionHandler.class
})
public class EncounterAdminIntegrationTestConfiguration {
}
