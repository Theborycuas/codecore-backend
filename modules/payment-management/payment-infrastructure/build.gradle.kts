...
dependencies {
    implementation(projects.modules.paymentManagement.paymentDomain)
    implementation(projects.modules.paymentManagement.paymentApplication)
    ...
    testImplementation(projects.modules.billingManagement.billingDomain)
    testImplementation(projects.modules.billingManagement.billingApplication)
