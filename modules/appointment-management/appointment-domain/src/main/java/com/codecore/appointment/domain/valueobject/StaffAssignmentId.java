...
/**
 * Logical reference to Organization Management {@code StaffAssignmentId} (ADR-011 / ADR-014).
 * Scope coherence via {@code StaffAssignmentReferencePort} in application — not this VO.
 */
