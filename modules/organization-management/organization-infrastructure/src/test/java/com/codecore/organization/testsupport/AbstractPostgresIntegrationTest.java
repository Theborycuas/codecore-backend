...
/**
 * Shared Testcontainers PostgreSQL + Flyway for Organization persistence integration tests.
 */
public abstract class AbstractPostgresIntegrationTest {
    ...
    protected static Connection openJdbcConnection() throws SQLException {
