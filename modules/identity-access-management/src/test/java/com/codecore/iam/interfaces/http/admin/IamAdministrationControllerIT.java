...
class IamAdministrationControllerIT extends AbstractPostgresIntegrationTest {
    ...
    @Test
    void shouldReturn200WhenCallerHasRoleReadPermission() {
        TenantId tenantId = provisionTenant();
        String email = uniqueEmail("admin-status");
        ...
        webTestClient.get()
                ...
                .jsonPath("$.permission").isEqualTo("role:read");
    }
    ...
    @Test
    void shouldReturn403WhenMembershipHasNoRoleReadPermission() {
        TenantId tenantId = provisionTenant();
        String email = uniqueEmail("admin-denied");
